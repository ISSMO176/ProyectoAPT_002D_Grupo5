...
import { Loader2, BarChart2, User, ChevronLeft, ChevronRight } from "lucide-react";
...
const Dashboard = () => {
  ...
  const currentDetalles =
    detallesUsuario?.respuestas.slice(indexOfFirstDetalle, indexOfLastDetalle) ||
    [];
        ...
        <Card className="mt-8">
          ...
          <CardContent>
            ...
            <div className="flex justify-center mt-4">
              ...
              {Array.from({
                length: Math.ceil(detallesUsuario.respuestas.length / detallesPorPagina),
              }).map((_, i) => (
                <Button
                  key={i}
              ...
              <Button
                ...
                disabled={
                  detallesPage ===
                  Math.ceil(detallesUsuario.respuestas.length / detallesPorPagina)
                }
              >
                <ChevronRight className="h-4 w-4" />
              </Button>
